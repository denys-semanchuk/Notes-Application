...
export const selectEditingCategory = (state: RootState) => state.categories.editingCategory;
export const selectSearchTerm = (state: RootState) => state.categories.searchTerm;
export const selectAvailableCategories = (state: RootState) => state.categories.availableCategories;
...
export const selectAllCategories = createSelector(
  ...
  (availableCategories, notes) => {
    ...
    const allCategories = new Set([...availableCategories, ...noteCategoriesSet]);
