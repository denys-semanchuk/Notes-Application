    ...
    <div className="home-page">
      {showWelcome && (
        ...
        >
          <div className="welcome-content">
            ...
            <p>Start organizing your thoughts with smart notes. Create your first note to get started.</p>
          </div>
      ...
      <div className="page-header">
        <div className="greeting-container">
          <h1>{greeting}!</h1>
          {notes.length > 0 && (
            <p className="stats-text">You have {notes.length} notes, {activeNotes.length} active</p>
          )}
        </div>
      ...
      <div className="quick-tip">
        ...
        <div>
          <h4>Pro Tip</h4>
          <p>Use keyboard shortcut <kbd>Ctrl</kbd> + <kbd>N</kbd> to quickly create a new note.</p>
        </div>
      </div>
    </div>
  );
