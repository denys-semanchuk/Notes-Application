...
import { selectAllCategories, selectCategoryStats, selectEditingCategory, selectEditMode, selectSearchTerm, selectSelectedCategory } from 'store/selectors/categorySelectors';
      ...
      >
        <div className="title-section">
          ...
          <div className="stats-pills">
            ...
            <span className="stat-pill total">{categories.length} Categories</span>
          </div>
        </div>
                    ...
                    >
                      {editingCategory === category ? (
                        ...
                        <>
                          ...
                          <span className="category-count">{stats?.count || 0}</span>
              ...
              <>
                <h2 className="selected-category-name">
                  <span 
                    ...
                    style={{ backgroundColor: categoryStats.get(selectedCategory)?.color }}
                  ></span>
                  {selectedCategory}
                </h2>
            ...
            <div className="category-notes">
              {filteredNotes.length > 0 ? (
                ...
                <EmptyState 
                  ...
                  title={searchTerm ? "No matching notes" : "No notes in this category"}
                  description={
                    searchTerm 
                      ? "Try adjusting your search or browsing all notes in this category."
                      : "Notes with this category will appear here."
                  }
                  buttonText={searchTerm ? "Clear Search" : "Browse All Notes"}
                  onButtonClick={() => 
                    searchTerm 
